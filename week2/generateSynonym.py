...
MODEL_PATH = os.path.join(ROOT_DIR, '..','workspace/datasets/fasttext/title_model_100.bin')
TOP_WORDS_PATH = os.path.join(ROOT_DIR, '..', 'workspace/datasets/fasttext/top_words.txt')
OUTPUT_CSV = os.path.join(ROOT_DIR,  '..','workspace/datasets/fasttext/synonyms.csv')
